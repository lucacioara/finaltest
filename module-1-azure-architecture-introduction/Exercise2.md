...
1. First, clone the repository on your local machine. You will find the source code of exercise 1 and the start of exercise 2 at `module-1-azure-architecture-introduction/src/Exercise_1`.
